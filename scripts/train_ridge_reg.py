...
train_ridge_reg.py
-------------
Train our data with ridge regression

Author  : Baptiste Gorteau
Date    : May 2025
Project : PRICE_PREDICTION_NYC_AIRBNB
File    : File that train data on ridge regression
"""
...
copy_X = [True, False]
parameters = {"alpha" : alphas, "fit_intercept":fit_intercept, "copy_X" : copy_X}
...
best_model = Ridge(alpha=best_parameters['alpha'], 
...
#===== SAVE THE MODEL =====
joblib.dump(best_model, "models/ridge_reg.joblib")
