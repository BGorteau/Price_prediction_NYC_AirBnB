...
When we look at the models, we can see that the three linear models have a very similar score. In contrast, the Random Forest and Gradient Boosting models have better scores with a slight preference for the Gradient Boosting model.
